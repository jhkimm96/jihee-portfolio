...
highlight: "공유 링크의 만료·권한 검증과 JWT 재발급 동시성 문제를 안전하게 설계했습니다."
responsibility: "인증·인가와 이력서 관리 기능의 백엔드 및 프론트엔드 구현"
contributions:
  - "JWT 인증과 리프레시 토큰 로테이션을 구현했습니다."
  - "이력서 항목과 버전 관리 데이터 구조를 설계했습니다."
  - "만료와 조회 권한을 포함한 공유 링크 정책을 구현했습니다."
  - "인증 상태와 이력서 편집 화면을 Next.js로 연결했습니다."
